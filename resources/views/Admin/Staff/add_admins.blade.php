    ...
    <div class="row mt-4">
        <div class="col-md-10 mx-auto rounded shadow-lg p-3 rounded">
            ...
            <div class="container mt-5">
                ...
                @endif
                <form class="form-horizontal" method="Post" action="{{route('add-admin-post')}}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="email" class="form-control" id="inputName2" placeholder="Email" name="email">
                            @error('email')
                            <p class="text-danger"> {{$message}}</p>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="password" class="form-control" id="inputName2" placeholder="Password" name="password_confirmation">
