        ...
        <div class="col-md-10 mx-auto rounded shadow-lg p-3 rounded">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" name="image_title" id="inputName" class="form-control {{($errors->first('image_title') ? " form-error" : "")}}" value="{{$data->image_title}}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea id="summernote" name="description" class="form-control {{($errors->first('description') ? " form-error" : "")}}" rows="4">{{$data->description}}</textarea>
                </div>
