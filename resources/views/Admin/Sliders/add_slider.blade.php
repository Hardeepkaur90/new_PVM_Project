    ...
    <div class="row mt-4">
        <div class="col-md-10 mx-auto rounded shadow-lg p-3 rounded">
            <div class="d-flex  justify-content-between">
                <span>
                    <h4> <i class="bi bi-file-earmark-plus"></i> Add Pages </h4>
                </span>
            </div>
            <div class="container mt-5">
                ...
                <form class="form-horizontal" method="Post" action="{{url('added')}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                           ...
                           @if(!empty($error = $errors->first('image_title')))
                                   <p class=" val-error"
                                style="margin-left: 6px;margin-top: 16px;margin-bottom: 31px;">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="file" class="form-control {{($errors->first('image') ? " form-error" : "")}}"
                                id="inputSkills" placeholder="Slug" name="image">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea id="summernote" name="description"
                                class="form-control {{($errors->first('description') ? " form-error" : "")}}"" rows="
                                4">
                            </textarea>
