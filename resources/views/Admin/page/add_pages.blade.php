    ...
    <div class="row mt-4">
        <div class="col-md-10 mx-auto rounded shadow-lg p-3 rounded">
            ...
            <div class="container mt-5">
                ...
                @endif
                <form class="form-horizontal" method="Post" action="{{url('add/pages/post')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group row">
                        <label for="inputExperience" class="col-sm-2 col-form-label">Page Title </label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="inputName2" placeholder="Page Title" name="pagetitle">
                            @error('pagetitle')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea id="summernote" name="pagedescription">
                            </textarea>
