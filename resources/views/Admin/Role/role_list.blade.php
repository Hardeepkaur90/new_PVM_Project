...
<div class="container-fluid rounded">
    <div class="d-flex  justify-content-between p-2">
        <div>
            <h2 class="mt-1 ml-2"> <i class="bi bi-person-bounding-box"></i> Role Management </h2>
        </div>
        <div class="mt-1">
            <a href="{{route('create-roles')}}" class="btn btn-info"> Add Roles </a>
        </div>
    </div>
    <div class="row mt-2">
        <div class="col-md-11 mx-auto rounded shadow-lg p-3 rounded">
            <div class="d-flex  justify-content-between">
                <span>
                    <h4> <i class="bi bi-table ml-3 mt-5 mr-2"></i>Roles List </h4>
                </span>
            </div>
