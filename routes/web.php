...
Route::post("faq-created", [faqController::class, 'addfaq']);

Route::get("faq-list", [faqController::class, 'show_faq']);

Route::get("faq/delete/{id}", [faqController::class, 'deletefaq']);

Route::get("faq/edit/{id}", [faqController::class, 'viewfaq']);

Route::post("updatedfaq", [faqController::class, 'updatefaq']);

Route::get("FAQ-page", [faqController::class, 'display_faq']);
